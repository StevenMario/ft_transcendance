...
export default function SearchBar() {
  return (
    <>
      {/* Search Bar */}
      <div className="md:w-177.25 md:h-17.5 mx-auto">
        <div className="flex items-center pl-6.5 pr-1 py-1 rounded-full shadow-lg border border-amber-600 overflow-hidden">
          <input
            type="text"
